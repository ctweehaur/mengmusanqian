const shortQData = [
    {
        ...
        sZh: [
            "1. 算出搬到学宫前搬家的总次数（注意不要把最后的学校也算进之前的次数）。",
            "2. 按照文章的前后顺序，依次列出前三个居住地点的名字（坟墓、集市、屠宰场）。"
        ],
        sPy: [
        ...
        aZh: "一共搬过三次家。他们先后居住在坟墓（墓地）旁边、集市旁边以及屠宰场附近。",
    ...
    {
        id: "Q2",
        qZh: "当他们住在第一个地方（坟墓附近）时，小小的孟子天天都在模仿和玩些什么事情？",
        ...
        sZh: [
            "1. 找到课文中第一部分的关键词句（学为丧葬，躄踊痛哭）。",
            "2. 用直白的白话文翻译出这些玩耍和模仿的具体丧葬行为（筑墓、出殡、大哭）。"
        ],
        sPy: [
        ...
        aPy: "mèng zǐ tiān tiān dōu zài mó fǎng hé xué xí jǔ bàn sāng lǐ de shì qíng wán shuǎ zhe chuí xiōng pāi dà tuǐ yīn bēi tòng ér tiào yuè yǐ jí shāng xīn tòng kū de yóu xì",
    ...
    },
    {
        ...
        sZh: [
            "1. 从课文中提取出孟母反复说的那句原话（此非所以居子也/是亦非所以居子矣）。",
            "2. 结合马来西亚中学理解要求，直白说明她担心环境会带坏孩子、影响孩子的思想和前途。"
        ],
        sPy: [
            "cóng kè wén zhōng tí qǔ chū mèng mǔ fǎn fù shuō de nà jù yuán huà",
            "jié hé lǐ jiě yào qiú zhí bái shuō míng tā dān yān huán jìng huì dài huài hái zǐ"
        ],
    ...
    {
        id: "Q4",
        qZh: "最后搬到学校（学宫）旁边后，孟子见到了什么场景？他接着怎么做？",
        ...
        sZh: [
            "1. 筛选出孟子在学宫旁见到的“官员入文庙行礼跪拜、揖让进退”的场景信息。",
            "2. 说明孟子的反应和做法（见了，一一习记）。"
        ],
        sPy: [
            "shāi xuǎn chū mèng zǐ zài xué gōng páng jiàn dào de guān yuán xíng lǐ de chǎng jǐng xìn xī",
    ...
    },
    {
        ...
        sZh: [
            "1. 用简单直接的语言提炼核心教训：说明朋友和周边环境对我们学生成长的巨大影响。",
            "2. 给学生提出实际行动建议：我们在学校和生活中要学会选择好朋友、远离不良风气。"
        ],
        sPy: [
