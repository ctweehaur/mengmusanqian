const quizQuestions = [
    ...
    },
    {
        ...
        options: [
            {
                text: "表因果关系的连词（因为……所以）",
                py: "biǎo yīn guǒ guān xì de lián cí yīn wèi suǒ yǐ",
            ...
            },
            {
                ...
                correct: true,
                explanation: "正确！在这里“所以”和后面的动词“居”结合，表示“用来居住、安置的地方”。",
                explanationPy: "zhèng què zài zhè lǐ suǒ yǐ hé hòu miàn de dòng cí jū jié hé biǎo shì yòng lái jū zhù ān zhì de dì fāng",
        ...
        options: [
            {
                ...
                explanationPy: "cuò wù zhè shì mèng zǐ zuì hòu bān dào xué xiào páng biān shí cai mó fǎng de xíng wéi",
            ...
            },
            {
                ...
                correct: false,
                explanation: "错误。这是他住在坟墓旁边时的游戏行为。",
            ...
            },
            {
                ...
                explanationPy: "zhèng què wén zhāng zhōng xiě dào tā bān dào shì páng hòu xī wéi gǔ rén xuàn mài zhī shì gǔ rén jiù shì shāng rén xuàn mài jiù shì jiào mài",
            ...
            },
            {
                ...
                correct: false,
                explanation: "错误。这是他住在屠宰场旁边时学做的事情。",
    ...
    },
    {
        ...
        options: [
            {
                text: "网络和房租比集市和屠宰场的更便宜",
                py: "wǎng luò hé fáng zū bǐ jí shì hé tú zǎi chǎng de gèng pián yí",
                en: "Because housing expenses there were cheaper than those near the market and slaughterhouse.",
                correct: false,
                explanation: "错误。文中完全没有提及房租或房价等经济因素，孟母搬家唯一的考量是教育环境。",
                explanationPy: "cuò wù wén zhāng zhōng wán quán méi yǒu tí jí fáng zū huò fáng jià děng jīng jì yīn sù mèng mǔ bān jiā wéi yī de kǎo liáng shì jiào yù huán jìng",
    ...
    },
    {
        ...
        py: "tōng guò mèng mǔ lián xù bān qiān sì cì dì diǎn de jīng lì zhǔ yào chuán dá le sh年 me jiào yù dào lǐ",
        ...
        options: [
            {
                ...
                explanationPy: "cuò wù pín fán huàn dì fāng shì wèi le bǎi tuō bù liáng fēng qì de yǐng xiǎng bú  shì wèi le ràng hái zǐ dào chù qù wán shuǎ yú lè",
            ...
            },
            {
                ...
                explanationEn: "Incorrect. She relocated away from markets because the environment was too rowdy and worldly for basic early upbringing, not as a vocational critique."
            }
        ]
    }
];
